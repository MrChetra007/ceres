      ...
      <span class="topbar-desktop-controls">
        ...
        <div class="settings-dropdown" ref="settingsWrap">
          ...
          <div class="settings-menu" v-show="settingsOpen" @click.stop>
            ...
            <!-- PWA install item disabled while diagnosing production loading.
...
// import { installApp as pwaInstallApp, showInstallHint } from '../services/pwa' // PWA disabled
...
// PWA install handler disabled while diagnosing production loading.
