  ...
  >
    ...
    <section id="hero" class="cl-hero">
      ...
      <div class="cl-hud cl-hud-left">
        <div class="cl-hud-live">
          <span class="cl-dot green pulse-dot"></span> Sentinel-2 · live feed
        </div>
      ...
      <div class="cl-hero-content">
        <div class="cl-eyebrow mb">
          <span class="cl-eyebrow-line"></span>For Cambodia's rain-fed rice
          farms
        </div>
        <h1 class="cl-h1">
          ...
          <span class="font-light">for the </span
          ><span class="font-serif italic text-gradient-green"
            >rice field.</span
          >
        </h1>
        <p class="cl-hero-sub">
          Ceres reads Sentinel-2 and Sentinel-1 satellite imagery and turns it
          into plain-language crop health alerts — sent straight to Telegram, in
          Khmer or English, before stress is ever visible to the eye.
        </p>
        <p class="cl-hero-khmer" lang="km">
          សេរេសអានរូបភាពផ្កាយរណប និងប្រាប់អ្នកពីសុខភាពស្រែរបស់អ្នក —
          មុនពេលមើលឃើញដោយភ្នែក។
        </p>
      ...
      <div class="cl-marquee">
        <div class="cl-marquee-track">
          <template v-for="n in 2" :key="n">
            <span class="cl-marquee-item"
              ><span class="cl-dot green"></span> NDVI · Normalized Difference
              Vegetation Index</span
            >
            <span class="cl-marquee-item"
              ><span class="cl-dot blue"></span> NDWI · Water stress</span
            >
            <span class="cl-marquee-item"
              ><span class="cl-dot bright"></span> LSWI · Leaf water
              content</span
            >
            <span class="cl-marquee-item"
              ><span class="cl-dot amber"></span> RVI · Radar vegetation index
              (cloud-penetration)</span
            >
            <span class="cl-marquee-item"
              ><span class="cl-dot green"></span> 6-stage rice phenology
              model</span
            >
            <span class="cl-marquee-item"
              ><span class="cl-dot blue"></span> 10-day revisit cadence</span
            >
          </template>
        </div>
      </div>
      ...
      <div class="cl-container">
        <div class="cl-heading-grid">
          ...
          <div class="cl-lead-col reveal delay-2">
            <p class="cl-lead">
              Most Cambodian rice farms are entirely rain-fed. No irrigation, no
              soil sensors, no drone flights. When a patch of a field starts to
              stress — too dry, too wet, nutrient-short, pest-hit — the farmer
              usually can't see it until the leaves yellow and curl. By then,
              the yield is already gone.
            </p>
            <p class="cl-lead-dim">
              The damage isn't visible from the ground until ~30% of the
              recoverable window has already closed. From orbit, it's visible in
              <span class="cl-bright">five days</span>.
            </p>
          </div>
        </div>
        ...
        <div class="reveal delay-3">
          <div class="cl-eyebrow">
            The cost of being late · visible-stress vs. satellite-detectable
            stress
          </div>
          <div class="cl-card p-6 lg-p8 cl-hud-card">
            ...
            <div class="cl-two-col mb">
              <div>
                ...
                <div class="cl-small-muted">
                  from onset to eye-visible yellowing
                </div>
              </div>
              <div>
                ...
                <div class="cl-small-muted">
                  from onset to satellite-detectable NDVI shift
                </div>
              </div>
            </div>
            ...
            <div class="cl-timeline">
              ...
              <div class="cl-tl-caption" style="left: 0">
                Day 0 · stress onset
              </div>
              <div
                class="cl-tl-caption blue"
                style="left: 17%; transform: translateX(-50%)"
              >
                Day 5 · Ceres alerts
              </div>
              <div class="cl-tl-caption red" style="right: 0">
                Day 30 · eye-visible
              </div>
            </div>
            ...
            <div class="cl-tier-stats">
              <div>
                ...
                <div class="cl-stat-lbl">
                  of Cambodian rice area is rain-fed, with no irrigation backup
                </div>
              </div>
              <div>
                <div class="cl-stat-num">~3M</div>
                <div class="cl-stat-lbl">
                  households depend on rice as their primary income
                </div>
              </div>
              <div>
                <div class="cl-stat-num">0</div>
                <div class="cl-stat-lbl">
                  early-warning tools built for a Khmer-speaking farmer on a $40
                  phone
                </div>
              </div>
            </div>
        ...
        <div class="cl-quote reveal">
          ...
          <p class="cl-quote-text">
            ...
            <span class="cl-not-italic cl-bright">before</span> — when something
            can still be done.
          </p>
          <div class="cl-quote-attrib">
            <span class="cl-hr"></span>Sok Vanna · rice farmer, Battambang
            Province
          </div>
        </div>
      </div>
    ...
    <section id="how" class="cl-section cl-how">
      ...
      <div class="cl-container">
        <div class="cl-heading-grid">
          ...
          <div class="cl-lead-col reveal delay-2">
            <p class="cl-lead">
              No new hardware in the field. No apps to install. Ceres runs on
              free public satellite data from the European Space Agency's
              Sentinel constellation and reaches farmers on the app they already
              use every day — Telegram.
            </p>
          </div>
        </div>
        ...
        <div class="cl-steps">
          <div class="cl-step reveal">
            ...
            <div class="cl-step-icon">
              <svg viewBox="0 0 80 60">
                ...
                <path
                  d="M30 36 L50 36 L60 52 L20 52 Z"
                  fill="var(--blue)"
                  opacity="0.08"
                />
                <path
            ...
            <p class="cl-step-body">
              ESA's Sentinel-2 (optical) captures 10-metre multispectral
              imagery. When clouds roll in during monsoon, Sentinel-1's radar
          ...
          <div class="cl-step reveal delay-1">
            ...
            <p class="cl-step-body">
              NDVI, NDWI, LSWI and RVI are computed per field, then weighed
              against growth-stage-aware thresholds across 6 stages of rice
              phenology.
            </p>
            <div class="cl-step-spec">
          ...
          <div class="cl-step reveal delay-2">
            ...
            <p class="cl-step-body">
              A language model translates the numbers into a plain-language,
              stage-aware explanation — water stress vs. nutrient stress vs.
              pest pressure — in Khmer and English.
            </p>
            <div class="cl-step-spec">
          ...
          <div class="cl-step reveal delay-3">
            ...
            <div class="cl-step-icon">
              <svg viewBox="0 0 80 60">
                ...
                />
                <path
                  d="M48 22 L32 30 L38 33 L40 38 L43 34 L48 36 Z"
                  fill="var(--blue)"
                />
            ...
            <p class="cl-step-body">
              The alert lands in Telegram — no new app, no logins. The farmer
              replies with a photo from the field for ground-truthing; the model
        ...
        <div class="cl-pipeline-status reveal delay-4">
          <div class="cl-ps-live">
            <span class="cl-dot green pulse-dot"></span> Pipeline live
          </div>
    ...
    <section id="features" class="cl-section cl-features">
      <div class="cl-container">
        <div class="cl-heading-grid">
          ...
          <div class="cl-lead-col reveal delay-2">
            <p class="cl-lead">
              For a co-op agronomist, Ceres is a precision-ag monitoring
              platform. For an individual farmer, it's a Telegram bot that just
              talks to them. Same engine, two surfaces — designed so the data
              only matters if it ends in action.
            </p>
          </div>
        </div>
          ...
          <div class="cl-card cl-hud-card cl-dashboard">
            ...
            <div class="cl-dash-top">
              <div class="cl-dash-top-left">
                <span class="cl-dash-field-label green"
                  ><span class="cl-dot green pulse-dot"></span> Field
                  dashboard</span
                >
              ...
              <div class="cl-dash-main p-lg">
                <div class="cl-dash-main-head">
                  ...
                  <div class="cl-band-row" ref="bandRow">
                    <button class="cl-band on" @click="switchBand($event)">
                      NDVI
                    </button>
                    <button class="cl-band" @click="switchBand($event)">
                      NDWI
                    </button>
                    <button class="cl-band" @click="switchBand($event)">
                      LSWI
                ...
                <div class="cl-timeline-slider">
                  ...
                  <div class="cl-ts-track">
                    ...
                    <div class="cl-ts-ticks">
                      <span>Aug 16</span><span>Sep 5</span><span>Sep 25</span
                      ><span>Oct 15</span><span>Nov 4</span><span>Nov 14</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="cl-dash-side p-lg">
                <div>
                  ...
                  <div class="cl-dash-health">
                    ...
                    <div class="cl-health-desc">
                      moderate stress · NW quadrant
                    </div>
                  </div>
                  <div class="cl-health-sub">
                    avg NDVI · down 0.12 vs 5d ago
                  </div>
                </div>

                <div class="cl-side-block">
                  <div class="cl-label muted">Growth stage</div>
                  <div class="cl-stage-name">
                    Tillering <span class="cl-stage-count">stage 3 / 6</span>
                  </div>
                  <div class="cl-stage-bar">
                    <i class="on"></i><i class="on"></i><i class="on bright"></i
                    ><i></i><i></i><i></i>
                  </div>
                  <div class="cl-stage-ticks">
                    <span>NR</span><span>TR</span><span>TL</span><span>PI</span
                    ><span>BT</span><span>RP</span>
                  </div>
                </div>
                ...
                <div class="cl-side-block">
                  ...
                  <div class="cl-zone" v-for="z in zones" :key="z.label">
                    ...
                    <div class="cl-zone-bar">
                      <div :class="z.color" :style="{ width: z.width }"></div>
                    </div>
                    <span class="cl-zone-val" :class="z.color">{{
                      z.value
                    }}</span>
                  </div>
                </div>
        ...
        <div class="cl-feature-row">
          <div class="cl-card feature-card p-6 reveal delay-1">
            ...
            <p class="cl-feature-body">
              An AI that has read your field's NDVI history and local rainfall
              explains what's happening — and what to do — in plain Khmer.
            </p>
            <div class="cl-chat">
              ...
              <div class="cl-chat-out">
                <div class="cl-bubble ai">
                  The north-west corner of BTB-04 dropped to NDVI 0.18 in the
                  last pass. Rainfall in your area has been 41% below the
                  10-year norm for this week of the season. At tillering stage,
                  this pattern matches water stress, not pest damage.
                </div>
                <div class="cl-avatar ci">C</div>
              </div>
              <div class="cl-chat-out">
                <div class="cl-bubble ai">
                  ប្រសិនបើអ្នកអាចបូកបាន សូមផ្ញើរូបថតចម្ងាយជិង។
                </div>
                <div class="cl-avatar ci">C</div>
              </div>
            </div>
          ...
          <div class="cl-card feature-card p-6 reveal delay-2">
            ...
            <p class="cl-feature-body">
              Ceres sends stage-aware, rainfall-contextualized alerts in Khmer
              or English — and the farmer replies with a photo from the field
              for ground-truthing.
            </p>
            <div class="cl-tg-mock">
              <div class="cl-tg-head">
                <div class="cl-tg-avatar">
                  <svg viewBox="0 0 20 20">
                    <path
                      d="M14 6 L7 11 L10 12 L11 15 L13 12 L16 13 Z"
                      fill="var(--blue)"
                    />
                  </svg>
                </div>
              ...
              <div class="cl-tg-alert">
                <div class="cl-tg-alert-head">
                  <span class="cl-dot red"></span> Stress alert · BTB-04
                </div>
                <div class="cl-tg-alert-text">
                  ស្រែរបស់អ្នកនៅតំបន់ពារព្យួរមានស្ថានភាពស្ងួត។
                  ភាគឦសាននៃចម្ការបានធ្លាក់ចុះ NDVI ចំនួន ០.១២។
                  ភ្លៀងធ្លាក់តិចជាងឆ្នាំទាំងអស់ ៤១%។
                  ផ្តល់អនុស្សារថាស្គាំញញក្នុងរយៈ ៥ ថ្ងៃ។
                </div>
          ...
          <div class="cl-card feature-card p-6 reveal delay-3">
            ...
            <p class="cl-feature-body">
              For co-ops and extension officers: see every member's fields in
              one health-ranked view, with a time-slider history, compare mode,
              and one-click PDF briefs per farmer.
            </p>
            <div class="cl-coop">
              <div class="cl-coop-head">
                <span>Farmer</span><span>Field</span><span>Stage</span
                ><span class="ta-r">NDVI · Δ5d</span>
              </div>
              <div class="cl-coop-row" v-for="r in coopRows" :key="r.name">
                ...
                <span class="cl-coop-val ta-r" :class="r.color"
                  ><b :class="r.color">{{ r.val }}</b
                  ><span :class="r.color">{{ r.delta }}</span></span
                >
              </div>
              <div class="cl-coop-foot">
                Showing 4 of 412 ·
                <span class="cl-amber">38 need attention</span>
              </div>
            </div>
          </div>
        </div>
    ...
    <section id="tiers" class="cl-section cl-tiers">
      <div class="cl-container">
        <div class="cl-heading-grid">
          ...
          <div class="cl-lead-col reveal delay-2">
            <p class="cl-lead">
              Ceres is built first for the farmer with one phone and one field.
              The co-op tier is the same engine, rolled up across hundreds of
              fields — for the agronomist who advises them all.
            </p>
          </div>
        </div>
        ...
        <div class="cl-tier-grid">
          <div class="cl-card cl-hud-card cl-tier reveal">
            ...
            <div class="cl-tier-head">
              <div>
                ...
                <h3 class="cl-tier-title">
                  Ceres <span class="italic">Farmer</span>
                </h3>
            ...
            <p class="cl-tier-desc">
              No app to install. The farmer chats with the Ceres Telegram bot in
              Khmer, draws their field on a map once, and receives alerts
              whenever a satellite pass detects stress.
            </p>
            <ul class="cl-tier-list">
              <li v-for="f in farmerFeatures" :key="f">
                <i class="ti ti-check"></i>{{ f }}
              </li>
            </ul>
            <button class="cl-btn primary full" @click="enter">
              Add your field <i class="ti ti-arrow-right"></i>
            </button>
          </div>
          ...
          <div class="cl-card cl-hud-card cl-tier featured reveal delay-1">
            ...
            <div class="cl-tier-head">
              <div>
                <div class="cl-tier-eyebrow amber">
                  Co-op · extension officer
                </div>
                <h3 class="cl-tier-title">
                  Ceres <span class="italic">Co-op</span>
                </h3>
                <p class="cl-tier-sub">
                  For co-ops, NGOs, and extension programs.
                </p>
              </div>
              <div class="ta-r">
            ...
            <p class="cl-tier-desc">
              A web dashboard that rolls up every member farmer's fields into
              one ranked view. Built for the agronomist who needs to triage 400
              fields in a morning.
            </p>
            <ul class="cl-tier-list">
              <li v-for="f in coopFeatures" :key="f">
                <i class="ti ti-check"></i>{{ f }}
              </li>
            </ul>
            <button class="cl-btn ghost full amber-b" @click="enter">
              Book a co-op demo <i class="ti ti-arrow-right"></i>
            </button>
          </div>
        </div>

        <div class="cl-real-pricing reveal">
          <div class="cl-eyebrow center mb">
            Plans &amp; pricing · real tiers
          </div>
          <PricingCards />
        </div>
      </div>
    ...
    <section id="waitlist" class="cl-waitlist">
      ...
      <div class="cl-waitlist-inner">
        <div class="cl-eyebrow center mb reveal">
          <span class="cl-eyebrow-line short"></span> Pilot · 2025 wet season
          <span class="cl-eyebrow-line short"></span>
        </div>
        <h2 class="cl-h2 center mb reveal delay-1">
          <span class="font-serif italic">See your field</span><br />
          from 786 km up —<br />
          <span class="text-gradient-green font-serif italic"
            >before it's too late.</span
          >
        </h2>
        <p class="cl-waitlist-sub reveal delay-2">
          Ceres is in pilot with rice co-ops across Battambang and Kampong Thom
          for the 2025 wet season. Farmers join free, forever. Co-ops book a
          30-minute walkthrough.
        </p>
        <button class="cl-btn primary lg reveal delay-3" @click="enter">
          Join the pilot <i class="ti ti-arrow-right"></i>
        </button>
        <div class="cl-waitlist-foot reveal delay-4">
          <span class="cl-wl-item"
            ><span class="cl-dot green"></span> Free for individual
            farmers</span
          >
          <span class="cl-wl-item"
            ><span class="cl-dot blue"></span> Works on any phone with
            Telegram</span
          >
          <span class="cl-wl-item"
            ><span class="cl-dot amber"></span> Khmer & English</span
          >
        </div>
      </div>
    </section>
    ...
    <footer class="cl-footer">
      <div class="cl-footer-grid">
        <div class="cl-footer-brand">
          ...
          <p class="cl-footer-desc">
            Early warning from orbit, for Cambodia's rice fields. Built for the
            AI in Motion accelerator.
          </p>
          <p class="cl-footer-khmer font-khmer" lang="km">
            សេរេស — ព្រមានមុន ពីលើអវកាស សម្រាប់ស្រែស្រូវកម្ពុជា។
          </p>
        </div>
        <div class="cl-footer-col">
          ...
          <a href="#waitlist" @click.prevent="scrollTo('#waitlist')"
            >Join the pilot</a
          >
        </div>
        <div class="cl-footer-col">
      ...
      <div class="cl-footer-bar">
        ...
        <div>
          ...
          <span class="cl-sys"
            ><span class="cl-dot green pulse-dot"></span> All systems
            nominal</span
          >
        </div>
      </div>
...
function drawNDVI() {
  ...
  function ndviColor(v) {
    if (v < 0.2) {
      const t = v / 0.2;
      return `rgb(${180 + t * 40}, ${50 + t * 30}, ${40 + t * 20})`;
    } else if (v < 0.4) {
      const t = (v - 0.2) / 0.2;
      return `rgb(${220 - t * 100}, ${120 + t * 60}, ${50 + t * 20})`;
    } else if (v < 0.6) {
      const t = (v - 0.4) / 0.2;
      return `rgb(${120 - t * 40}, ${140 + t * 30}, ${70})`;
    } else if (v < 0.8) {
      const t = (v - 0.6) / 0.2;
      return `rgb(${80 - t * 40}, ${170 + t * 20}, ${80})`;
    } else {
      const t = (v - 0.8) / 0.2;
      return `rgb(${130 + t * 40}, ${190 + t * 20}, ${98})`;
    }
  }
  const cols = 64,
    rows = 36;
...
function initGlobe(container) {
  ...
  globeGroup.add(
    new THREE.Mesh(new THREE.SphereGeometry(R * 0.985, 48, 48), innerMat),
  );
  ...
  for (let i = 0; i <= segs; i++) {
    const t = (i / segs) * Math.PI * 2;
    eqPts.push(R * 1.005 * Math.cos(t), 0, R * 1.005 * Math.sin(t));
  }
  ...
  const marker = new THREE.Mesh(
    ...
    new THREE.MeshBasicMaterial({ color: 0xb8e062 }),
  );
  ...
  const beam = new THREE.Mesh(
    new THREE.CylinderGeometry(0.005, 0.005, 0.35, 8),
    new THREE.MeshBasicMaterial({
      color: 0xb8e062,
      transparent: true,
      opacity: 0.4,
  ...
  for (let i = 0; i <= 200; i++) {
    ...
    oPts.push(1.95 * Math.cos(t), 0, 1.85 * Math.sin(t));
  }
  const oGeo = new THREE.BufferGeometry().setFromPoints(oPts);
  const oMat = new THREE.LineDashedMaterial({
    color: 0x4ad6e4,
    transparent: true,
    opacity: 0.35,
    dashSize: 0.08,
  ...
  container.addEventListener("mousedown", (e) => {
    ...
    dragRotXTarget = dragRotX;
    dragRotYTarget = dragRotY;
  });
  const onMouseMove = (e) => {
    if (isDragging) {
      dragRotYTarget = dragRotY + (e.clientX - dragStartX) * 0.005;
      dragRotXTarget = dragRotX + (e.clientY - dragStartY) * 0.005;
    }
  ...
  const onMouseUp = () => {
    if (isDragging) {
      isDragging = false;
      dragRotX = dragRotXTarget;
      dragRotY = dragRotYTarget;
    }
  };
  ...
  const onTouchMove = (e) => {
    if (isDragging && e.touches.length === 1) {
      dragRotYTarget = dragRotY + (e.touches[0].clientX - dragStartX) * 0.005;
      dragRotXTarget = dragRotX + (e.touches[0].clientY - dragStartY) * 0.005;
    }
  };
  ...
  function animate() {
    ...
    globeGroup.rotation.x = Math.max(
      -0.5,
      Math.min(0.5, globeGroup.rotation.x + dragRotX * 0.02),
    );
    scene.rotation.y = mouseX * 0.05;
    scene.rotation.x = mouseY * 0.03;
    satT += dt * 0.18;
    const sx = 1.95 * Math.cos(satT),
      sz = 1.85 * Math.sin(satT);
    const syT = -sz * Math.sin(orbitTilt),
      szT = sz * Math.cos(orbitTilt);
    satGroup.position.set(sx, syT, szT);
    satGroup.lookAt(
      1.95 * Math.cos(satT + 0.01),
      0,
      1.85 * Math.sin(satT + 0.01),
    );
...
.cl-btn:hover {
  ...
  box-shadow: 0 8px 24px -8px rgba(143, 186, 74, 0.5);
}
.cl-btn.ghost {
...
.cl-btn.ghost.amber-b {
  border-color: rgba(240, 160, 64, 0.4);
  color: var(--amber);
}
.cl-btn.ghost.amber-b:hover {
...
.cl-grid-bg {
  ...
  pointer-events: none;
  background-image:
    linear-gradient(rgba(120, 145, 175, 0.04) 1px, transparent 1px),
    linear-gradient(90deg, rgba(120, 145, 175, 0.04) 1px, transparent 1px);
...
.cl-step-kicker.green {
  color: var(--green);
}
.cl-step-kicker.amber {
  color: var(--amber);
}
.cl-step-meta {
  font-family: "JetBrains Mono", monospace;
...
.cl-crosshair-box {
  ...
  border: 1px solid rgba(235, 231, 212, 0.6);
}
.cl-crosshair-tag {
  position: absolute;
  top: -14px;
...
.cl-ts-progress {
  ...
  left: 0;
  width: 78%;
  background: rgba(143, 186, 74, 0.1);
...
.cl-feature-kicker.green {
  color: var(--green);
}
.cl-feature-kicker.blue {
  color: var(--blue);
}
.cl-feature-kicker.amber {
  color: var(--amber);
}
.cl-feature-title {
  font-family: "Instrument Serif", serif;
...
.cl-avatar.ci {
  background: rgba(143, 186, 74, 0.2);
  color: var(--green);
}
.cl-bubble {
  font-size: 11px;
...
.cl-bubble.ai {
  background: rgba(143, 186, 74, 0.15);
  border: 1px solid rgba(143, 186, 74, 0.3);
  color: var(--green-bright);
  max-width: 80%;
}
...
.cl-tg-avatar {
  ...
  height: 28px;
  border-radius: 50%;
  background: rgba(74, 214, 228, 0.2);
  display: flex;
  align-items: center;
  justify-content: center;
}
...
.cl-tier-eyebrow.green {
  color: var(--green);
}
.cl-tier-eyebrow.amber {
  color: var(--amber);
}
.cl-tier-title {
  font-family: "Instrument Serif", serif;
...
.cl-tier.featured .cl-tier-list li i {
  color: var(--amber);
}
...
.cl-orbit-ring.ring2 {
  width: 90%;
  aspect-ratio: 1;
  transform: translate(-50%, -50%) rotate(-15deg) scaleY(0.4);
}
.cl-orbit-ring.ring3 {
  width: 60%;
  aspect-ratio: 1;
  transform: translate(-50%, -50%) rotate(20deg) scaleY(0.3);
}
.cl-h2.center {
  text-align: center;
  margin-left: auto;
