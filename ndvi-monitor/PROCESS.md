...
- `migration9.sql`: `profiles.preferred_language` (`'en'`/`'km'`, default `'en'`).

### 14.3 Ground-truth photo attachments ✅
- `migration10.sql`: **private** `field-photos` storage bucket (public=false) + `pending_photo` table.
